...
class OCVLidctNode(OCVLNode):
    ...
    src_in = StringProperty(name="src_in", default=str(uuid.uuid4()), description=_("Input floating-point single-channel array."))
...
def register():
    cv_register_class(OCVLidctNode)


def unregister():
    cv_unregister_class(OCVLidctNode)
