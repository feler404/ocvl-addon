...
class OCVLdivideNode(OCVLNodeBase):
    ...
    n_requirements = {"__and__": ["src_1_in", "src_2_in"]}
    n_quick_link_requirements = {"src_1_in": {"code_in": "COLOR_BGR2GRAY"}, "src_2_in": {"code_in": "COLOR_BGR2GRAY"}}
    ...
    def wrapped_process(self):
        ...
        dst_out = self.process_cv(fn=cv2.divide, kwargs=kwargs)
