...
class OCVLapproxPolyDPNode(OCVLNodeBase):
    ...
    epsilon_in: bpy.props.FloatProperty(default=0.1, update=update_node, description="Parameter specifying the approximation accuracy. This is the maximum distance")
