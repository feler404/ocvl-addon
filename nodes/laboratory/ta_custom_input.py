...
class OCVLCustomInputNode(OCVLNodeBase):
    ...
    def init(self, context):
        ...
        self.inputs.new("OCVLObjectSocket", INPUT_NAME_TEMPLATE.format(0))
    ...
    def wrapped_process(self):
        ...
        for var_name in new_vars:
            ...
            if socket_name not in self.outputs:
                self.outputs.new("OCVLObjectSocket", socket_name)
    ...
    def _refresh_inputs(self):
        ...
        if self.inputs[-1].is_linked:
            ...
            self.inputs.new("OCVLObjectSocket", new_socket_name)
