...
class OCVLfastNlMeansDenoisingColoredNode(OCVLNodeBase):
    ...
    n_quick_link_requirements = {"templateWindowSize_in": {"loc_input_mode": "MANUAL", "loc_manual_input": "7"},
                                 ...
                                 "hForColorComponents_in": {"loc_input_mode": "MANUAL", "loc_manual_input": "3"}}
    ...
    hForColorComponents_in: bpy.props.StringProperty(name="hForColorComponents_in", default=str(uuid.uuid4()), description="The same as h but for color components. For most images value equals 10 will be enought to remove colored noise and do not distort colors.")
    ...
    def init(self, context):
        ...
        self.inputs.new("OCVLVectorSocket", "hForColorComponents_in")
    ...
    def wrapped_process(self):
        kwargs = {
            ...
            'hForColorComponents_in': self.get_from_props("hForColorComponents_in"),
        }
