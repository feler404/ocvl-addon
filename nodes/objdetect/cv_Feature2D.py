...
WORK_MODE_PROPS_MAPS = {
    ...
    WORK_MODE_ITEMS[1][0]: ("image_in", "keypoints_in", "descriptors_out"),
...
class OCVLFeature2DNode(OCVLNode):
    ...
    loc_state_mode = EnumProperty(items=STATE_MODE_ITEMS, default="LOAD", update=update_layout, description=_(""))
    ...
    def sv_init(self, context):
        ...
        self.inputs.new("StringsSocket", "loc_file_load").prop_name = 'loc_file_load'
        self.inputs.new("StringsSocket", "loc_file_save").prop_name = 'loc_file_save'
    ...
    def update_sockets(self, context):
        self.update_sockets_for_node_mode(STATE_MODE_PROPS_MAPS, self.loc_state_mode)
