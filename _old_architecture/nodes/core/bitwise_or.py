...
class OCVLbitwise_orNode(OCVLNode):

    bl_develop_state = DEVELOP_STATE_BETA

    _doc = _("Calculates the per-element bit-wise disjunction of two arrays or an array and a scalar.")
...
def register():
    cv_register_class(OCVLbitwise_orNode)


def unregister():
    cv_unregister_class(OCVLbitwise_orNode)
