...
class OCVLclipLineNode(OCVLNodeBase):
    ...
    imgRect_in = bpy.props.StringProperty(name="imgRect_in", default=str(uuid.uuid4()),
        description="Image rectangle.")
    ...
    pt1_in = bpy.props.IntVectorProperty(default=(0, 0), size=2, min=0, update=update_node,
        description="First point of the line segment.")
    pt2_in = bpy.props.IntVectorProperty(default=(1, 1), size=2, min=0, update=update_node,
