...
class OCVLboxFilterNode(OCVLNodeBase):
    ...
    ksize_in = bpy.props.IntVectorProperty(default=(3, 3), min=1, max=30, size=2, update=update_node,
    ...
    normalize_in = bpy.props.BoolProperty(default=True, update=update_node,
