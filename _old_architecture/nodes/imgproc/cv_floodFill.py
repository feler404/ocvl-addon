...
class OCVLfloodFillNode(OCVLNodeBase):
    ...
    rect_out = bpy.props.IntVectorProperty(default=(0, 0, 1, 1), size=4,
        description="Rect output.")

    seedPoint_in = bpy.props.IntVectorProperty(default=(0, 0), size=2, update=update_node,
        description="Starting point.")
    newVal_in = bpy.props.FloatVectorProperty(update=update_node, default=(.1, .1, .1, 1.0), size=4, min=0.0, max=1.0, subtype='COLOR',
        description="New value of the repainted domain pixels.")
    loDiff_in = bpy.props.FloatVectorProperty(update=update_node, default=(.1, .1, .1, 1.0), size=4, min=0.0, max=1.0, subtype='COLOR',
    ...
    upDiff_in = bpy.props.FloatVectorProperty(update=update_node, default=(.9, .9, .9, 1.0), size=4, min=0.0, max=1.0, subtype='COLOR',
    ...
    flag_fixed_range_in = bpy.props.BoolProperty(default=False, update=update_node,
    ...
    flag_mask_only_in = bpy.props.BoolProperty(default=False, update=update_node,
