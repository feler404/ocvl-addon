...
class OCVLFREAKNode(OCVLFeature2DNode):
    ...
    loc_work_mode = bpy.props.EnumProperty(items=FREAK_WORK_MODE_ITEMS, default="COMPUTE", update=update_layout, description="")
    ...
    patternScale_init = bpy.props.FloatProperty(default=22.0, min=0, max=100, update=update_layout, description="")
