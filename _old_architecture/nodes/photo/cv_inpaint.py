...
class OCVLinpaintNode(OCVLNodeBase):
    ...
    image_in = bpy.props.StringProperty(name="image_in", default=str(uuid.uuid4()),
                              description="desc")
    inpaintMask_in = bpy.props.StringProperty(name="inpaintMask_in", default=str(uuid.uuid4()),
    ...
    inpaintRadius_in = bpy.props.FloatProperty(default=3, min=1, max=10, update=update_node,
